const cards = [
  {
    title: "Máquinas",
    desc: "Cadastre, edite, gere QR Codes e gerencie vínculos de equipamentos.",
    href: "/admin/machines",
  ...
  {
    title: "Templates",
    desc: "Crie e edite perguntas personalizadas para operador ou mecânico.",
  ...
  },
  {
    ...
    desc: "Monitore e gerencie todas as não conformidades identificadas.",
  ...
  },
  {
    ...
    desc: "Acompanhe métricas de performance e indicadores de qualidade.",
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-foreground-secondary">
              Bem-vindo ao sistema de gestão de frota. Selecione um módulo para começar.
            </p>
          </div>
        </div>
      </header>
